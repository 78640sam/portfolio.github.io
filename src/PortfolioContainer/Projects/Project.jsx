            ...
            <div className="projectMain" id="project">
                ...
                <div className="projectCardDiv secProject">
                    <div className="projectDetail">
                        <h3>Vrbo Clone</h3>
                        <p>This is a team project where we worked on cloning the Vrbo. Vrbo is an American vacation rental online marketplace originally known as Vacation Rentals by Owner or VRBO. It was acquired by HomeAway in 2006. We have built this using HTML, CSS, JavaScript and React</p>
                        <div className="links">
